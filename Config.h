...
#define CLK_FREQ_32000000                       1                                //32MHz

#if((CLK_FREQ_25000000+CLK_FREQ_24000000+CLK_FREQ_20000000+CLK_FREQ_16000000+CLK_FREQ_12000000+CLK_FREQ_32000000) != 1)
...
//**********************************************************************
		...
		#define BAUD_RATE	38
//**********************************************************************
//#define CLOCK_FREQUENCY  	32000000   				 //32MHz
//Note: 1 INST Cycle = ((1/ CLOCK_SPEED) * 4) = (1/32000000)*4 = 0.125Us
//		Total INST Cycle in a loop = 0.125*8 = 1.00 ~ 1Us.
//**********************************************************************
//
//#elif (CLK_FREQ_32000000)
//		#define wait(a) _asm movlw a\
//					  movwf macro_delay,1\
//			  loop:	  nop\
//					  nop\
