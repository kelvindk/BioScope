 ...
 * Author: larry
 *
 * Created on August 31, 2015, 6:36 PM
 */
...
extern BOOL initAPDS9960(APDS9960_t *pApds);
UINT8 getMode();
...
extern BOOL enableGestureSensor(APDS9960_t *pApds, BOOL interrupts);
void resetGestureParameters(APDS9960_t *pApds);
BOOL setLEDBoost(UINT8 boost);
BOOL setGestureMode(UINT8 mode);
BOOL enablePower();

extern int handleGesture(APDS9960_t *pApds, UINT8 loopCounter);
